...
# Local imports
from grid_project.utilities.decorators import timer
...
class InnerMesh:
    """
        This class is responsible for the densities inside the interface. It is created to greatly improve
        resolution
    """
